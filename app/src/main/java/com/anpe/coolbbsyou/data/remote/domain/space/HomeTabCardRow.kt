...
data class HomeTabCardRow(
    ...
    @SerializedName("relationRows")
    val relationRows: List<Any> = listOf(),
    ...
    @SerializedName("tags")
    val tags: String = "",
    @SerializedName("targetRow")
    val targetRow: TargetRow = TargetRow(),
    @SerializedName("tcat")
    val tcat: Int = 0,
    @SerializedName("tid")
    val tid: Long = 0,
    ...
    val title: String = "",
    @SerializedName("top_reply_ids")
    val topReplyIds: List<Any> = listOf(),
    @SerializedName("tpic")
    val tpic: String = "",
