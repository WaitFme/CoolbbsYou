...
import com.anpe.coolbbsyou.net.model.nofitication.NotificationModel
import com.anpe.coolbbsyou.net.model.profile.ProfileModel
import com.anpe.coolbbsyou.net.model.search.SearchModel
                ...
                val client = OkHttpClient.Builder()
                    ...
                    .addInterceptor {
                        val request = it.request().newBuilder()
                            .addHeader(Constants.USER_AGENT_KEY, Utils.getUserAgent())
