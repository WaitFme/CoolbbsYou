...
data class Data(
    ...
    @Json(name = "fromname")
    val fromname: String = "",
    @Json(name = "goodsDisplayLimit")
    val goodsDisplayLimit: Int = 0,
    @Json(name = "hitnum")
    val hitnum: Int = 0,
    @Json(name = "hotReplyRows")
    val hotReplyRows: List<HotReplyRow> = listOf(),
    @Json(name = "id")
    val id: Int = 0,
    @Json(name = "include_goods")
    val includeGoods: List<IncludeGood> = listOf(),
    ...
    @Json(name = "recentReplyRows")
    val recentReplyRows: List<RecentReplyRow> = listOf(),
    @Json(name = "recommend")
    val recommend: Int = 0,
